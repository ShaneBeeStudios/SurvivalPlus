...
public class Recipes {
    ...
    public static void init(Config config) {
        ...
        QUARTZ_PICKAXE = register(config.legendary_quartzpickaxe, Items.QUARTZ_PICKAXE.getRecipe());
        OBSIDIAN_MACE = register(config.legendary_obsidian_mace, Items.OBSIDIAN_MACE.getRecipe());
        ENDER_GIANT_BLADE = register(config.legendary_giantblade, Items.ENDER_GIANT_BLADE.getRecipe());
        BLAZE_SWORD = register(config.legendary_blazesword, Items.BLAZE_SWORD.getRecipe());
        ...
        GOLD_CROWN = register(config.legendary_goldarmorbuff, Items.GOLDEN_CROWN.getRecipe());
        GOLD_GUARD = register(config.legendary_goldarmorbuff, Items.GOLDEN_GUARD.getRecipe());
        GOLD_GREAVES = register(config.legendary_goldarmorbuff, Items.GOLDEN_GREAVES.getRecipe());
        GOLD_SABATONS = register(config.legendary_goldarmorbuff, Items.GOLDEN_SABATONS.getRecipe());
