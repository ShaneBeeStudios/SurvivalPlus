...
import com.shanebeestudios.survival.item.items.armor.ArmorPiece;
...
import com.shanebeestudios.survival.item.items.armor.BeekeeperPiece;
import com.shanebeestudios.survival.item.items.armor.RainBoots;
import com.shanebeestudios.survival.item.items.armor.ReinforcedPiece;
import com.shanebeestudios.survival.item.items.armor.SnowBoots;
import com.shanebeestudios.survival.item.items.blocks.Campfire;
import com.shanebeestudios.survival.item.items.blocks.Workbench;
import com.shanebeestudios.survival.item.items.drinks.Coffee;
import com.shanebeestudios.survival.item.items.drinks.ColdMilk;
import com.shanebeestudios.survival.item.items.drinks.HotMilk;
import com.shanebeestudios.survival.item.items.drinks.Water;
import com.shanebeestudios.survival.item.items.food.SuspiciousMeat;
import com.shanebeestudios.survival.item.items.legendary.BlazeSword;
import com.shanebeestudios.survival.item.items.legendary.EnderGiantBlade;
import com.shanebeestudios.survival.item.items.legendary.ObsidianMace;
import com.shanebeestudios.survival.item.items.legendary.QuartzPickaxe;
import com.shanebeestudios.survival.item.items.legendary.ValkyriesAxe;
import com.shanebeestudios.survival.item.items.misc.BreedingEgg;
import com.shanebeestudios.survival.item.items.misc.CoffeeBean;
import com.shanebeestudios.survival.item.items.misc.FermentedSkin;
import com.shanebeestudios.survival.item.items.tools.Compass;
import com.shanebeestudios.survival.item.items.tools.FireStriker;
import com.shanebeestudios.survival.item.items.tools.GrapplingHook;
import com.shanebeestudios.survival.item.items.tools.Hammer;
